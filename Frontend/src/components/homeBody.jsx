        ...
        <div className='home_body'>
            <div className="introSection" style={{display:"inline-block"}}>
                ...
                <div className="introSecText">
                    ...
                    <button type="button" class="btn btn-outline-secondary introSecButton "><span style={{color:'white'}}>Get Started</span></button>
                </div>
            </div>
            <div className="loginSection" style={{display:"inline-block"}}>
                <div className="loginSecText">
                    ...
                    <button type="button" href='' class="btn btn-outline-secondary introSecButton btn-lg" style={{width:'45%', textAlign:"center", marginLeft:'25%'}}><span style={{color:'white'}}>Login Now</span></button>
                </div>
            </div>
        </div>
        </>
