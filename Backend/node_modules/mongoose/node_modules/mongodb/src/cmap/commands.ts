...
/** @internal */
<<<<<<< Updated upstream:Backend/node_modules/mongoose/node_modules/mongodb/src/cmap/commands.ts
export class Msg {
=======
export class OpMsgRequest {
>>>>>>> Stashed changes:Backend/node_modules/mongodb/src/cmap/commands.ts
  requestId: number;
  serializeFunctions: boolean;
  ignoreUndefined: boolean;
  checkKeys: boolean;
