...
<<<<<<< Updated upstream:Backend/node_modules/mongoose/node_modules/mongodb/src/sdam/monitor.ts
  const isAwaitable = topologyVersion != null;
=======
  const isAwaitable = useStreamingProtocol(monitor, topologyVersion);
>>>>>>> Stashed changes:Backend/node_modules/mongodb/src/sdam/monitor.ts
  monitor.emit(
